...
Manuscripts in-prep {data-icon=file-lines}
--------------------------------------------------------------------------------

::: aside
```{r}
CV %<>% print_text_block('herbvar_aside')
```
:::

```{r}
CV %<>% print_section('in_prep')
```
...
Selected presentations  {data-icon=chart-bar}
--------------------------------------------------------------------------------

::: aside
```{r}
CV %<>% print_text_block('blog_aside')
```
:::
...
::: aside
```{r}
CV %<>% print_text_block('open_aside')
```
:::
